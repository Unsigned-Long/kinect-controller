...
namespace ns_runtime_flags {
  // format: [flag:msg1:msg2:...:msgn]
  static constexpr int COLOR_DEPTH_TIME = 0;
  static constexpr int INFO_MESSAGE_TEXTVIEW = 1;
  static constexpr int INFO_MESSAGE_TOAST = 2;
} // namespace ns_runtime_flags
