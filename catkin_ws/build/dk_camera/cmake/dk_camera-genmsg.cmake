...
set(MSG_I_FLAGS "-Idk_camera:/home/csl/TempWork/catkin_ws/src/dk_camera/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/csl/TempWork/catkin_ws/src/dk_camera/msg/DK_INFO.msg" NAME_WE)
add_custom_target(_dk_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dk_camera" "/home/csl/TempWork/catkin_ws/src/dk_camera/msg/DK_INFO.msg" ""
)
...
_generate_msg_cpp(dk_camera
  "/home/csl/TempWork/catkin_ws/src/dk_camera/msg/DK_INFO.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dk_camera)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dk_camera\")")
  # install generated code
  install(
